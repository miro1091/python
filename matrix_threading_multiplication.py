...
class Thread1(threading.Thread):
    ...
    def run(self):
        ...
        result[0][0] += vector_3x1a[0] * vector_1x3b[0]
        result[0][1] += vector_3x1a[0] * vector_1x3b[1]
        result[0][2] += vector_3x1a[0] * vector_1x3b[2]

        result[1][0] += vector_3x1a[1] * vector_1x3b[0]
        result[1][1] += vector_3x1a[1] * vector_1x3b[1]
        result[1][2] += vector_3x1a[1] * vector_1x3b[2]

        result[2][0] += vector_3x1a[2] * vector_1x3b[0]
        result[2][1] += vector_3x1a[2] * vector_1x3b[1]
        result[2][2] += vector_3x1a[2] * vector_1x3b[2]
